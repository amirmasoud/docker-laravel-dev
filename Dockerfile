...
LABEL Maintainer="Amirmasoud Sheydaei <amirmasoud.sheydaei@gmail.com>" \
    Description="Lightweight container with Laravel Docker development"

# Install packages and remove default server definition
RUN apk --no-cache add php7 php7-fpm php7-opcache php7-sqlite3 php7-pgsql \
    php7-mysqli php7-json php7-openssl php7-curl php7-zlib php7-xml php7-phar \
